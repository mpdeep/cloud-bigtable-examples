...
public class WordCount {
 ...
 // The configuration key used to specify the BigQuery field name
   ...
   * Google Cloud Storage (GCS) data, e.g., gs://bucket/dir/
   *
  ...
  public static void main(String[] args)
   ...
   // Define the schema we will be using for the output BigQuery table.
    ...
    // into a GCS temporary table, and then on commitJob, copies all data from
    // GCS into BigQuery in one operation. Its use is recommended for large jobs
    ...
    // After the job completes, clean up the Google Cloud Storage export paths.
